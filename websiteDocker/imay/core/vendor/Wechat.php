...
class Wechat
{
	...
	const CUSTOM_SEND_URL='/message/custom/send?';//多客服发送消息
...
<Nonce><![CDATA[%s]]></Nonce>
	...
	protected function setCache($cachename,$value,$expired){
        //todo 这里setCache,会出现一致性的问题
        $ret = \think\Cache::set($cachename, $value, $expired);
        return $ret;
	}
	...
	public function checkAuth($appid='',$appsecret='',$token=''){
		...
		$authname = "g:imay:baseaccesstoken";
    ...
    public function getForeverList($type,$offset,$count){
        ...
        $result = $this->http_post(self::API_URL_PREFIX.self::MEDIA_FOREVER_BATCHGET_URL.'access_token='.$this->access_token,\json_encode($data));
        if ($result)
        {
            $json = json_decode($result,true);
            if (isset($json['errcode'])) {
	...
	/**
	 * 发送客服消息 http://mp.weixin.qq.com/wiki/11/c88c270ae8935291626538f9c64bd123.html#.E5.AE.A2.E6.9C.8D.E6.8E.A5.E5.8F.A3-.E5.8F.91.E6.B6.88.E6.81.AF
