...
class Admin extends Base{
	...
	public function _initialize(){
		...
		if (!is_login() and !in_array(strtolower($this->url),array('admin/index/login', 'admin/index/logout', 'admin/index/verify'))) {
			$this->redirect('admin/index/login');
		}

		if (!in_array(strtolower($this->url),array('admin/index/login', 'admin/index/logout', 'admin/index/verify'))) {
