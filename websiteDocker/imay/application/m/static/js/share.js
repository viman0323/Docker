...
function setFront() {
    $(".s-play").hide();
    setTimeout('$(".s-video-a").addClass("s-video-s");',500);
...
function setIMayHeight(){
    ...
    // $("#iMayVideo").css("height",clientHeight);
}
function openMask() {
    $("#imay-mask").show();
    $(".iMay-shadow").css("z-index","101");
    $(".w-mes").css("z-index","102");
}
function closeMask() {
    $("#imay-mask").hide();
    $(".iMay-shadow").css("z-index","101");
