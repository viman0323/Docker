<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"/home/web/imay/application/m/view/share/superLive.html";i:1499362784;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<article>
    ...
    <section>
        <div class="z-mid" id="zVideo">
            ...
            <!-- 倒计时 -->
            <div class="z-count z-pos">
                <img src="__IMG__/superlive/number3.png" class="z-num z-num-s">
                <img src="__IMG__/superlive/number0.png" class="z-num z-num-g">
                <img src="__IMG__/superlive/sec.png" class="z-sec">
            </div>
