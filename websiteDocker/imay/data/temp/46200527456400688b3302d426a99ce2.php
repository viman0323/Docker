        ...
        <div class="g-c-log">
            <div class="pay-con">
                ...
                <div class="pay-c-m">
                    ...
                    <div class="g-code">
                        <span class="g-code-t1">支付金额：<b><?php echo $money; ?></b>元</span>
                        <span class="g-code-t2">为了确保安全，请尽快完成支付</span>
                        <img src="<?php echo $img_url; ?>" class="pay-img01">
                        <?php if($type == 'weixin'): ?>
        ...
        <div class="g-c-log-success">
            <div class="pay-con">
                ...
                <div class="pay-t-but pay-but-a">
                    <a href="<?php echo url('user/recharge/index'); ?>" class="imay-rc">确定</a>
                </div>
            </div>
        </div>
        <!--支付失败-->
...
<script type="text/javascript">
    ...
    function getStatus() {
        ...
        if (num != 2) {
            $.post("<?php echo url('user/recharge/notice'); ?>", {'out_trade_no': out_trade_no, 'type': type}, function (data) { //查询是否支付
