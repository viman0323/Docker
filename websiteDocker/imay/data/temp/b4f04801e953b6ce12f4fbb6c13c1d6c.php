...
<article>
    ...
    <section>
        <div class="charm-bar clearfix">
            <ul class="charm-bar-ul">
                <li>
                    <h5 class="charm-bar-tit">今日</h5>
                    <div class="charm-bar-c">
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">收入：</span>
                            <span class="charm-txt-b art-red"><b><?php echo (isset($statData['incomeday']) && ($statData['incomeday'] !== '')?$statData['incomeday']:0); ?></b> 魅力 </span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">收入排名：</span>
                            <span class="charm-txt-b art-red"><b><?php echo (isset($statData['incomerankday']) && ($statData['incomerankday'] !== '')?$statData['incomerankday']:0); ?></b> 名 </span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">即将超越：</span>
                            <span class="charm-txt-b art-blue"><b> <?php echo (isset($statData['willsurpassday']) && ($statData['willsurpassday'] !== '')?$statData['willsurpassday']:0); ?> </b></span>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="charm-bar-c">
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">收入：</span>
                            <span class="charm-txt-b art-red"><b><?php echo (isset($statData['incomeweek']) && ($statData['incomeweek'] !== '')?$statData['incomeweek']:0); ?></b> 魅力 </span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">收入排名：</span>
                            <span class="charm-txt-b art-red"><b> <?php echo (isset($statData['incomerankweek']) && ($statData['incomerankweek'] !== '')?$statData['incomerankweek']:0); ?> </b> 名 </span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">即将超越：</span>
                            <span class="charm-txt-b art-blue"><b> <?php echo (isset($statData['willsurpassweek']) && ($statData['willsurpassweek'] !== '')?$statData['willsurpassweek']:0); ?> </b></span>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="charm-bar-c">
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">收入：</span>
                            <span class="charm-txt-b art-red"><b><?php echo (isset($statData['incomemonth']) && ($statData['incomemonth'] !== '')?$statData['incomemonth']:0); ?></b> 魅力 </span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">收入排名：</span>
                            <span class="charm-txt-b art-red"><b> <?php echo (isset($statData['incomerankmonth']) && ($statData['incomerankmonth'] !== '')?$statData['incomerankmonth']:0); ?> </b> 名 </span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">即将超越：</span>
                            <span class="charm-txt-b art-blue"><b> <?php echo (isset($statData['willsurpassmonth']) && ($statData['willsurpassmonth'] !== '')?$statData['willsurpassmonth']:0); ?> </b></span>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    <section>
        <div class="art-warp art-bot">
            <table class="charm-table">
                ...
                <tbody>
                    <?php if(is_array($statData['last30incomestat']) || $statData['last30incomestat'] instanceof \think\Collection): $i = 0; $__LIST__ = $statData['last30incomestat'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><?php echo date('Y-m-d',strtotime($vo['Date'])); ?></td>
                        <td><?php echo $vo['Total']; ?></td>
                        <td><?php echo $vo['Livetotal']; ?></td>
                        <!--<td><?php echo $vo['RedEnvelope']; ?></td>-->
                        <td><?php echo $vo['GameIncome']; ?></td>
                        <td><?php echo $vo['FeedIncome']; ?></td>
                    </tr>
