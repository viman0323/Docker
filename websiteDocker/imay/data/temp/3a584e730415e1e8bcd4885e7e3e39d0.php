            ...
            <div class="art-tri-con">
                <div class="art-tri-d tri-d-show">
                    <table class="art-tri-table">
                        ...
                        <tbody>
                            <?php if(is_array($rankList['income']) || $rankList['income'] instanceof \think\Collection): $i = 0; $__LIST__ = $rankList['income'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                ...
                <div class="art-tri-d">
                    <table class="art-tri-table">
                        ...
                        <tbody>
                            <?php if(is_array($rankList['outcome']) || $rankList['outcome'] instanceof \think\Collection): $i = 0; $__LIST__ = $rankList['outcome'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td><b class="art-red art-font-s"><?php echo $i; ?></b>名</td>
                                <td><?php echo $vo['user']['nick']; ?></td>
                                <td><?php echo $vo['user']['roomId']; ?></td>
                ...
                <div class="art-tri-d">
                    <table class="art-tri-table">
                        ...
                        <tbody>
                            <?php if(is_array($rankList['prise']) || $rankList['prise'] instanceof \think\Collection): $i = 0; $__LIST__ = $rankList['prise'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td><b class="art-red art-font-s"><?php echo $i; ?></b>名</td>
                                <td><?php echo $vo['user']['nick']; ?></td>
                                <td><?php echo $vo['user']['roomId']; ?></td>
