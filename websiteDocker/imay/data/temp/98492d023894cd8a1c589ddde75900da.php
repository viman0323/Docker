...
<article>
    ...
    <section>
        <div class="art-warp">
            <ul class="art-w-ul">
                ...
                <li>
                    <div class="art-ul-l">
                        <span class="art-ul-tit">直播时长：</span>
                        <span class="art-red art-txt-a"><b><?php echo (isset($overview['livetimeday']['hour']) && ($overview['livetimeday']['hour'] !== '')?$overview['livetimeday']['hour']:0); ?></b>小时<b><?php echo (isset($overview['livetimeday']['min']) && ($overview['livetimeday']['min'] !== '')?$overview['livetimeday']['min']:0); ?></b>分</span>
                    </div>
                    <div class="art-ul-c">
                        <span class="art-ul-tit">直播时长：</span>
                        <span class="art-red art-txt-a"><b><?php echo (isset($overview['livetimemonth']['hour'] ) && ($overview['livetimemonth']['hour']  !== '')?$overview['livetimemonth']['hour'] :0); ?></b>小时<b><?php echo (isset($overview['livetimemonth']['hour']) && ($overview['livetimemonth']['hour'] !== '')?$overview['livetimemonth']['hour']:0); ?></b>分</span>
                    </div>
                    <div class="art-ul-r">
                        <a href="<?php echo url('Broker/Actor/statLive'); ?>" class="art-det-link">
                            <span>直播间详情</span>
                            <b></b>
                        </a>
                    </div>
                ...
                <li>
                    <div class="art-ul-l">
                        <span class="art-ul-tit">魅力收入：</span>
                        <span class="art-green art-txt-a"><b><?php echo (isset($overview['incomeday']) && ($overview['incomeday'] !== '')?$overview['incomeday']:0); ?></b></span>
                    </div>
                    <div class="art-ul-c">
                        <span class="art-ul-tit">魅力收入：</span>
                        <span class="art-green art-txt-a"><b><?php echo (isset($overview['incomemonth']) && ($overview['incomemonth'] !== '')?$overview['incomemonth']:0); ?></b></span>
                    </div>
                    <div class="art-ul-r">
                        <a href="<?php echo url('Broker/Actor/statIncome'); ?>" class="art-det-link">
                            <span>收入详情</span>
                            <b></b>
                        </a>
                    </div>
                ...
                <li>
                    <div class="art-ul-l">
                        <span class="art-ul-tit">新增粉丝：</span>
                        <span class="art-txt-a"><b><?php echo (isset($overview['fansincrday']) && ($overview['fansincrday'] !== '')?$overview['fansincrday']:0); ?></b></span>
                    </div>
                    <div class="art-ul-c">
                        <span class="art-ul-tit">新增粉丝：</span>
                        <span class="art-txt-a"><b><?php echo (isset($overview['fansincrmonth']) && ($overview['fansincrmonth'] !== '')?$overview['fansincrmonth']:0); ?></b></span>
                    </div>
                    <div class="art-ul-r">
                        <a href="<?php echo url('Broker/Actor/statFans'); ?>" class="art-det-link">
                            <span>粉丝详情</span>
                            <b></b>
                        </a>
                    </div>
                ...
                <li>
                    <div class="art-ul-la">
                        <div class="art-ul-l art-la-w">
                            <span class="art-ul-tit">发布图片：</span>
                            <span class="art-txt-a"><b><?php echo (isset($overview['imgfeedcount']) && ($overview['imgfeedcount'] !== '')?$overview['imgfeedcount']:0); ?></b></span>
                        </div>
                        <div class="art-ul-c art-la-w">
                            <span class="art-ul-tit">发布视频：</span>
                            <span class="art-txt-a"><b><?php echo (isset($overview['vediofeedcount']) && ($overview['vediofeedcount'] !== '')?$overview['vediofeedcount']:0); ?></b></span>
                        </div>
                        <div class="art-ul-r">
                            <a href="<?php echo url('Broker/Actor/statFeed'); ?>" class="art-det-link">
                                <span>动态详情</span>
                                <b></b>
                            </a>
                        </div>
    ...
    <section>
        <div class="art-warp art-bot">
            <div class="art-tab-tri">
                <ul class="tab-tri-ul">
                    <li class="tri-default">今日贡献榜</li>
                    <li>本周贡献榜</li>
                    <li>本月贡献榜</li>
                </ul>
            </div>
            <div class="art-tri-con">
                <div class="art-tri-d tri-d-show">
                    <table class="art-tri-table">
                        <thead>
                            <tr>
                                <th>名次</th>
                                <th>昵称</th>
                        ...
                        <tbody>
                            <?php if(is_array($contributeList['giftrankday']) || $contributeList['giftrankday'] instanceof \think\Collection): $i = 0; $__LIST__ = $contributeList['giftrankday'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td><b class="art-red art-font-s"><?php echo $i; ?></b>名</td>
                                <td><?php echo $vo['user']['nick']; ?></td>
                                <td><?php echo $vo['user']['roomId']; ?></td>
                ...
                <div class="art-tri-d">
                    <table class="art-tri-table">
                        ...
                        <tbody>
                            <?php if(is_array($contributeList['giftrankweek']) || $contributeList['giftrankweek'] instanceof \think\Collection): $i = 0; $__LIST__ = $contributeList['giftrankweek'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td><b class="art-red art-font-s"><?php echo $i; ?></b>名</td>
                                <td><?php echo $vo['user']['nick']; ?></td>
                                <td><?php echo $vo['user']['roomId']; ?></td>
                ...
                <div class="art-tri-d">
                    <table class="art-tri-table">
                        ...
                        <tbody>
                            <tr>
                                <?php if(is_array($contributeList['giftrankmonth']) || $contributeList['giftrankmonth'] instanceof \think\Collection): $i = 0; $__LIST__ = $contributeList['giftrankmonth'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td><b class="art-red art-font-s"><?php echo $i; ?></b>名</td>
                                <td><?php echo $vo['user']['nick']; ?></td>
                                <td><?php echo $vo['user']['roomId']; ?></td>
