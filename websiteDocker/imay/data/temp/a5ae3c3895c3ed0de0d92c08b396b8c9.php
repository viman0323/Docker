<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"/home/web/imay/application/index/view/download/indexInvite.html";i:1489659878;s:75:"/home/web/imay/application/index/view/../../common/view/default/header.html";i:1499155465;s:75:"/home/web/imay/application/index/view/../../common/view/default/footer.html";i:1489659878;s:74:"/home/web/imay/application/index/view/../../common/view/default/login.html";i:1492712428;}*/ ?>
<!DOCTYPE html>
<html lang="zh_CN">
<head>
...
<div class="g-wrap">
    <div class="g-con g-c-bg">
        <a class="g-h3-ic"></a>
        <h3 class="g-h3-bg"><b>抢先邀请</b></h3>
        <div class="g-c-log">
            <div class="ex-earn-t cap-wrap">
                <!--<div class="cap-wrap-a">-->
                <!--<div class="pay-txt">-->
                <!--<div class="pop-info">-->
                <!--<input type="text" name="code" placeholder="请填写邀请码" maxlength=16>-->
                <!--<span class="info-mes">请填写邀请码</span>-->
                <!--</div>-->
                <!--</div>-->
                <!--<div class="pay-t-but pay-but-a">-->
                <!--<a class="imay-rc" href="javascript:void (0)" id="Test">验证</a>-->
                <!--</div>-->
                <!--</div>-->
                <div class="cap-wrap-b" style="display: block;">
                    <div class="cap-b-t">
                        <img src="__IMG__/iMayCode.png">
                        <img src="__IMG__/c-01.png" class="cap-mes">
                        <span>手机扫描二维码</span>
                    </div>
    ...
    <div class="alipay-p-con">
        <ul class="pop-lg-ul" style="margin-top: 60px;">
            ...
            <li style="margin-top: 30px;">
                <a href="javascript:void (0)" class="imay-a0">确定</a>
            </li>
        </ul>
    </div>
</div>
<!-- 提取确认信息 -->
<div class="g-pop alipay-detail-pop">
    <div class="pop-close"></div>
    <div class="alipay-p-con">
        <ul class="pop-ad-ul">
            <li>
            ...
            <li>
                <span>提现支付宝账户：***8899@QQ。com</span>
            </li>
            <li class="info-code">
                <span class="ali-p-t2">提现魅力： <b>12888</b></span>
            </li>
            <li>
                <span class="ali-p-t3"> 到账金额：<b>1000</b></span>
            </li>
            <li>
                <div class="ali-but">
                ...
                <div class="ali-mes">
                    <span class="info-mes" style="display: block;">密码不能为空</span>
                </div>
...
<script>
    $(function () {
        $("#Test").click(function () {
            ...
            $.ajax({
                type   : 'post',
                url    : '<?php echo url("m/download/verification"); ?>',
                data   : params,
