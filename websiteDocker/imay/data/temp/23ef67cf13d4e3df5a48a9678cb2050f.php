...
<article>
    ...
    <section>
        <div class="charm-bar clearfix inter-bar">
            <ul class="charm-bar-ul inter-ul">
                <li>
                    <h5 class="charm-bar-tit">今日</h5>
                    <div class="charm-bar-c inter-h-a">
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">发布动态数：</span>
                            <span class="charm-txt-b art-red"><b><?php echo (isset($statData['feedcountweek']) && ($statData['feedcountweek'] !== '')?$statData['feedcountweek']:0); ?></b></span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">动态获得赞：</span>
                            <span class="charm-txt-b art-red"><b> <?php echo (isset($statData['feedcountweek']) && ($statData['feedcountweek'] !== '')?$statData['feedcountweek']:0); ?> </b></span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">动态礼物收入：</span>
                            <span class="charm-txt-b art-blue"><b> <?php echo (isset($statData['feedcountweek']) && ($statData['feedcountweek'] !== '')?$statData['feedcountweek']:0); ?> </b></span>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="charm-bar-c inter-h-a">
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">发布动态数：</span>
                            <span class="charm-txt-b art-red"><b><?php echo (isset($statData['feedcountmonth']) && ($statData['feedcountmonth'] !== '')?$statData['feedcountmonth']:0); ?></b></span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">发布图片数：</span>
                            <span class="charm-txt-b art-red"><b> <?php echo (isset($statData['imgcountmonth']) && ($statData['imgcountmonth'] !== '')?$statData['imgcountmonth']:0); ?> </b></span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">发布视频数：</span>
                            <span class="charm-txt-b art-blue"><b> <?php echo (isset($statData['vediocountmonth']) && ($statData['vediocountmonth'] !== '')?$statData['vediocountmonth']:0); ?> </b></span>
                        </div>
                    </div>
                </li>
                <li>
                    <h5 class="charm-bar-tit">上周</h5>
                    <div class="charm-bar-c inter-h-b">
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">获得赞：</span>
                            <span class="charm-txt-b art-red"><b><?php echo (isset($statData['praiselastweek']) && ($statData['praiselastweek'] !== '')?$statData['praiselastweek']:0); ?></b> 魅力 </span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">转发数：</span>
                            <span class="charm-txt-b art-red"><b> <?php echo (isset($statData['repostlastweek']) && ($statData['repostlastweek'] !== '')?$statData['repostlastweek']:0); ?> </b> 名 </span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">评论数：</span>
                            <span
                                class="charm-txt-b art-red"><b> <?php echo (isset($statData['commentlastweek']) && ($statData['commentlastweek'] !== '')?$statData['commentlastweek']:0); ?> </b> 名 </span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">礼物收入：</span>
                            <span class="charm-txt-b art-blue"><b> <?php echo (isset($statData['giftlastweek']) && ($statData['giftlastweek'] !== '')?$statData['giftlastweek']:0); ?> </b></span>
                        </div>
                    </div>
                </li>
                <li>
                    <h5 class="charm-bar-tit">上上周</h5>
                    <div class="charm-bar-c inter-h-b">
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">获得赞：</span>
                            <span class="charm-txt-b art-red"><b><?php echo (isset($statData['praiselast2week']) && ($statData['praiselast2week'] !== '')?$statData['praiselast2week']:0); ?></b> 魅力 </span>
                            <span class="art-red">涨：<?php echo (isset($statData['praiselast2week']) && ($statData['praiselast2week'] !== '')?$statData['praiselast2week']:0); ?>%</span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">转发数：</span>
                            <span
                                class="charm-txt-b art-red"><b> <?php echo (isset($statData['repostlast2week']) && ($statData['repostlast2week'] !== '')?$statData['repostlast2week']:0); ?> </b> 名 </span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">评论数：</span>
                            <span
                                class="charm-txt-b art-red"><b> <?php echo (isset($statData['commentlast2week']) && ($statData['commentlast2week'] !== '')?$statData['commentlast2week']:0); ?> </b> 名 </span>
                            <span class="art-green">跌：<?php echo (isset($statData['commentlast2week']) && ($statData['commentlast2week'] !== '')?$statData['commentlast2week']:0); ?>%</span>
                            <div class="charm-line"></div>
                        </div>
                        <div class="charm-bar-l">
                            <span class="charm-txt-a">礼物收入：</span>
                            <span class="charm-txt-b art-blue"><b> <?php echo (isset($statData['giftlast2week']) && ($statData['giftlast2week'] !== '')?$statData['giftlast2week']:0); ?> </b></span>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    <section>
        <div class="art-warp art-bot">
            <table class="charm-table">
                ...
                <tbody>
                    <?php if(is_array($statData['last30feedsnsstat']) || $statData['last30feedsnsstat'] instanceof \think\Collection): $i = 0; $__LIST__ = $statData['last30feedsnsstat'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
