...
<div class="g-wrap">
    <div class="g-con">
        ...
        <div class="g-c-log">
            <div class="pay-con">
                <div class="ex-earn-t">
                    <div class="pay-txt pay-txt-g ex-earn-mes">
                        <b class="pay-s-icon"></b>
                        申请已提交！
                    </div>
                    <div class="ex-earn-txt">
                        工作人员需三个工作日完成提现审核工作，请您耐心等待~
                    </div>
                    <div class="pay-t-but pay-but-a">
                        <a class="imay-rc" href="<?php echo url('user/withdraw/index'); ?>">返回</a>
                    </div>
                </div>
            </div>
