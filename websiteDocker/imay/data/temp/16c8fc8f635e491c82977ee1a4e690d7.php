...
<article>
                ...
                <li>
                    <div class="charm-bar-c">
                        <div class="charm-bar-l">
                            ...
                            <span class="charm-txt-a">新增粉丝：</span>
                            <span class="charm-txt-b art-red"><b><?php echo (isset($statData['fansincrday']) && ($statData['fansincrday'] !== '')?$statData['fansincrday']:0); ?></b></span>
                            <div class="charm-line-a"></div>
                        </div>
                        <div class="charm-bar-l">
                            <h5 class="charm-bar-tit">本周</h5>
                            <span class="charm-txt-a">新增粉丝：</span>
                            <span class="charm-txt-b art-red"><b> <?php echo (isset($statData['fansincrweek']) && ($statData['fansincrweek'] !== '')?$statData['fansincrweek']:0); ?> </b> 名 </span>
                            <div class="charm-line-a"></div>
                        </div>
                        <div class="charm-bar-l">
                            <h5 class="charm-bar-tit">本月</h5>
                            <span class="charm-txt-a">新增粉丝：</span>
                            <span class="charm-txt-b art-blue"><b> <?php echo (isset($statData['fansincrmonth']) && ($statData['fansincrmonth'] !== '')?$statData['fansincrmonth']:0); ?> </b></span>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="charm-bar-c">
                        <div class="charm-bar-l">
                            ...
                            <span class="charm-txt-a">新增粉丝：</span>
                            <span class="charm-txt-b art-red"><b><?php echo (isset($statData['fansincrlastweek']) && ($statData['fansincrlastweek'] !== '')?$statData['fansincrlastweek']:0); ?></b></span>
                            <div class="charm-line-a"></div>
                        </div>
                        <div class="charm-bar-l">
                            <h5 class="charm-bar-tit">上上周</h5>
                            <span class="charm-txt-a">新增粉丝：</span>
                            <span class="charm-txt-b art-red"><b> <?php echo (isset($statData['fansincrlast2week']) && ($statData['fansincrlast2week'] !== '')?$statData['fansincrlast2week']:0); ?> </b> 名 </span>
                            <div class="charm-line-a"></div>
                        </div>
                        <div class="charm-bar-l">
                            <h5 class="charm-bar-tit">涨跌</h5>
                            <span class="charm-txt-a">新增粉丝：</span>
                            <span class="charm-txt-b art-blue"><b> <?php echo (isset($statData['percent']) && ($statData['percent'] !== '')?$statData['percent']:0); ?> </b></span>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="charm-bar-c">
                        <div class="charm-bar-l">
                            <h5 class="charm-bar-tit">15级以上</h5>
                            <span class="charm-txt-a">新增粉丝：</span>
                            <span class="charm-txt-b art-red"><b><?php echo (isset($statData['fanslv15']) && ($statData['fanslv15'] !== '')?$statData['fanslv15']:0); ?></b></span>
                            <div class="charm-line-a"></div>
                        </div>
                        <div class="charm-bar-l">
                            <h5 class="charm-bar-tit">30级以上</h5>
                            <span class="charm-txt-a">新增粉丝：</span>
                            <span class="charm-txt-b art-red"><b> <?php echo (isset($statData['fanslv30']) && ($statData['fanslv30'] !== '')?$statData['fanslv30']:0); ?> </b> 名 </span>
                            <div class="charm-line-a"></div>
                        </div>
                        <div class="charm-bar-l">
                            <h5 class="charm-bar-tit">40级以上</h5>
                            <span class="charm-txt-a">新增粉丝：</span>
                            <span class="charm-txt-b art-blue"><b> <?php echo (isset($statData['fanslv40']) && ($statData['fanslv40'] !== '')?$statData['fanslv40']:0); ?> </b></span>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    <section>
        <div class="art-warp art-bot">
            <table class="charm-table fan-table">
                <thead>
                <tr>
                    <th>日期</th>
                    <th>新增粉丝</th>
                ...
                <tbody>
                    <?php if(is_array($statData['last30fansstat']) || $statData['last30fansstat'] instanceof \think\Collection): $i = 0; $__LIST__ = $statData['last30fansstat'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><?php echo date('Y-m-d',strtotime($vo['Date'])); ?></td>
                        <td><?php echo $vo['IncrFans']; ?></td>
                        <td><?php echo $vo['DecrFans']; ?></td>
                        <td><?php echo $vo['TotalFans']; ?></td>
                    </tr>
